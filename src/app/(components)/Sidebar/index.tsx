...
const Sidebar = () => {
  ...
  return <div className={sideClassName}>
    ...
    <div className="flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700">
      <Image src="/logo.png" alt="Logo" width={40} height={40} className="w-[40px] h-[40px]" />
...
const SidebarLink = ({
  ...
  return (
    <Link href={href} className="w-full relative">
      <div className={`relative flex cursor-pointer items-center gap-3 transition-colors hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-black
